docker run -ti --rm \
	...
	--network=host \
    --volume=/ceph/users/usq33871/data/ds000114:/data \
    --volume=/ceph/users/usq33871/projects/test_docker:/outputs \
	--volume=/ceph/users/usq33871/projects/reproa/tests:/config \
	reproa:dev /data /outputs participant --participant_label sub-01 --config /config/ds114_test1.xml:/config/ds114_test1.m --skip_bids_validator